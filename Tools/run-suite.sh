...
PART_A='Brink.Tests.ActionIndexTests|Brink.Tests.OppositionTests|Brink.Tests.CouncilTests|Brink.Tests.AttentionSystemTests|Brink.Tests.ForceInventoryTests|Brink.Tests.GovernmentSystemTests|Brink.Tests.MapAndLayoutTests|Brink.Tests.OperationCatalogTests'
PART_B='Brink.Tests.InsurgencyTests|Brink.Tests.VerticalSliceValidationTests|Brink.Tests.WorldInvariantTests|Brink.Tests.AISystemTests|Brink.Tests.BugRegressionTests|Brink.Tests.PartialSystemsTests|Brink.Tests.WorldHeatTests'
